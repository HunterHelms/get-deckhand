...
import 'home_hiring_dashboard_model.dart';
export 'home_hiring_dashboard_model.dart';

class HomeHiringDashboardWidget extends StatefulWidget {
  const HomeHiringDashboardWidget({Key? key}) : super(key: key);

  @override
  _HomeHiringDashboardWidgetState createState() =>
      _HomeHiringDashboardWidgetState();
}

class _HomeHiringDashboardWidgetState extends State<HomeHiringDashboardWidget>
    with TickerProviderStateMixin {
  late HomeHiringDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeHiringDashboardModel());
