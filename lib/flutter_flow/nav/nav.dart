...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Robin1Login',
          path: '/robin1Login',
          builder: (context, params) => Robin1LoginWidget(),
        ),
        FFRoute(
          name: 'onboard1',
          path: '/onboard1',
        ...
        FFRoute(
          name: 'Home_candidate_Dashboard',
          path: '/homeCandidateDashboard',
        ...
        FFRoute(
          ...
          path: '/profile01',
          requireAuth: true,
          builder: (context, params) => Profile01Widget(),
        ),
        FFRoute(
          name: 'Home_hiring_v2',
          path: '/homeHiringV2',
          builder: (context, params) => HomeHiringV2Widget(),
        ),
        FFRoute(
          name: 'createJob_v1',
          path: '/createJobV1',
